...
app_urls = {
    'App 2': 'http://10.195.176.87:8000/documentsummarizer',
    'App 1': 'https://dev.ai.newyorklifeinvestments.com/documentsummarizer/'
}
...
def update_metrics(n):
    ...
    username = headers_data.get('Cn', 'Guest')
    aws_role = 'App1' 
...
from documentsummarizer import app

# Create the dispatcher middleware to route requests to the respective Dash app
app1 = DispatcherMiddleware(server, {
    '/documentsummarizer': app.server,
})
